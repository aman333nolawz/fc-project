...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (themeBtn) {
    themeBtn.addEventListener("click", (e) => {
      ...
      console.log("Theme toggle clicked at:", x, y);

      if (!document.startViewTransition) {
        console.warn(
          "View Transition API not supported, toggling theme without animation.",
        );
        toggleTheme();
        return;
      }
      ...
      transition.ready
        ...
        .catch((error) => {
          console.error("View Transition API error:", error);
        });
    });
  }
